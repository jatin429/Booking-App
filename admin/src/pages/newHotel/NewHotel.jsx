...
const NewHotel = () => {
  ...
  const handleSelect=(e)=>{
    const id=Array.from(e.target.selectedOptions,option=>option.value);
    setRooms(id);
}
        ...
        try{
          // uploading images
           const list=await Promise.all(Object.values(files).map(async(file)=>{
            ...
            const uploadRes=await axios.post("https://api.cloudinary.com/v1_1/dtnqarlnd/image/upload",data);
